...
\newcommand{\RPLBench}{\textnormal{\textsc{RPLBench Builder}}}
...
\title{\vspace{-1.5em}\textbf{RPLBench：面向工具调用智能体的冗余参数泄露评测数据构建}\\[0.35em]
...
\input{sections/02_background_toolprivacybench}
\input{sections/03_source_analysis}
\input{sections/04_adapter}
\input{sections/05_formalization}
\input{sections/06_privacy_construction}
\input{sections/07_implementation_reproducibility}
\input{sections/08_evaluation}
\input{sections/09_case_studies}
\input{sections/10_limitations_ethics}
